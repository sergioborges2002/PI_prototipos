...
namespace teste.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Preco,CategoriaId,ImagemUrl")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Preco,CategoriaId,IsFavorito,ImagemUrl")] Produto produto)
        {
        ...
        {
            var produtos = _context.Produtos.Include(p => p.Categoria)
                .Where(p => p.CategoriaId == 2).ToList();
            return View(produtos);
        }
